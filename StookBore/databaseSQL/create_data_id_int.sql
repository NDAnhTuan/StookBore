...
VALUES (0,'Le Duan','Quan 1','Ho Chi Minh','Viet Nam'),
	   ...
	   (4,'Tran Nhan Tong','Vinh Lam','Vinh','Viet Nam'),
	   (5,'Vo Thi Sau','Vinh Son','Hue','Viet Nam'),
	   (6,'Dinh Bo Linh','Vinh Nam','Quy Nhon','Viet Nam'),
	   (7,'Le Quy Don','Quang Vinh','Nghe An','Viet Nam'),
	   (8,'Ngo Quyen','Quang Dien','Ha Long','Viet Nam'),
	   (9,'Nguyen Hue','Hoan Kiem','Ha Noi','Viet Nam'),
		(10,'Ly Thuong Kiet','Thanh Xuan','Ha Noi','Viet Nam'),
		(11,'Pham Hung','Nam Tu Liem','Ha Noi','Viet Nam'),
		(12,'Hoang Quoc Viet','Ba Dinh','Ha Noi','Viet Nam'),
		(13,'Pham Ngu Lao','Quan 1','Ho Chi Minh','Viet Nam'),
		(14,'Nguyen Hue','Quan 1','Ho Chi Minh','Viet Nam'),
		(15,'Le Loi','Quan 1','Ho Chi Minh','Viet Nam'),
		(16,'Nguyen Thi Minh Khai','Quan 3','Ho Chi Minh','Viet Nam'),
		(17,'Cong Xa','Quan 10','Ho Chi Minh','Viet Nam'),
		(18,'Nguyen Van Cu','Quan 1','Ho Chi Minh','Viet Nam'),
		(19,'Nguyen Thi Minh Khai','Quan 1','Ho Chi Minh','Viet Nam');
...
VALUES ('Success','Normal','2023-05-01',10,2,'123 Main Street','District 1','Ho Chi Minh City','Vietnam','Cash','2023-04-01',0),
